...
/// A row you get from running the `engineer_role_upsert` query
/// defined in `./src/tempo/server/engineer/sql/engineer_role_upsert.sql`.
///
/// > 🐿️ This type definition was generated automatically using v4.7.0 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub type EngineerRoleUpsertRow {
  EngineerRoleUpsertRow(revised: Int)
}
...
pub fn engineer_role_upsert(
  ...
  arg_3: Int,
  arg_4: Int,
) -> Result(pog.Returned(EngineerRoleUpsertRow), pog.QueryError) {
  let decoder = {
    use revised <- decode.field(0, decode.int)
    decode.success(EngineerRoleUpsertRow(revised:))
  }
