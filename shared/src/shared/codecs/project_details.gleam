//// JSON codec for `ProjectDetailsCommand` — the project-details aggregate's slice
//// of the command wire contract (the two edit-grouped facts: profile = title +
//// summary; plan = budget + target_completion). `encode` tags each variant by its
